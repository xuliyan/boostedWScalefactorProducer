  ...
  if(TString(wtagger_label.c_str()).Contains("0v45") or TString(wtagger_label.c_str()).Contains("0v50") or TString(wtagger_label.c_str()).Contains("0v55")){
    ...
    if( model == "2Gaus_ttbar"){
      ...
      if( TString(label).Contains("TotalMC")){
        rrv_mean2_gaus  = new RooRealVar(("rrv_mean2_gaus"+label+"_"+channel+spectrum).c_str(),("rrv_mean2_gaus"+label+"_"+channel+spectrum).c_str(),96.1,80,150);//,20,130.);
        rrv_sigma2_gaus = new RooRealVar(("rrv_sigma2_gaus"+label+"_"+channel+spectrum).c_str(),("rrv_sigma2_gaus"+label+"_"+channel+spectrum).c_str(),26.5,20,120);//,0,700);
     }
     
     if(TString(label.c_str()).Contains("fail")){
       rrv_mean2_gaus  = new RooRealVar(("rrv_mean2_gaus"+label+"_"+channel+spectrum).c_str(),("rrv_mean2_gaus"+label+"_"+channel+spectrum).c_str(),100.1);//,80,150.);
       rrv_sigma2_gaus = new RooRealVar(("rrv_sigma2_gaus"+label+"_"+channel+spectrum).c_str(),("rrv_sigma2_gaus"+label+"_"+channel+spectrum).c_str(),41.);//,0.,60.);
     }
