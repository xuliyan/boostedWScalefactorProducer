  ...
  */
  ...
  class ElectronNtupleObject : public SInputVariables< SCycleBaseNTuple > {
    ...
    enum ConnectionIndex { 
     kpassConversionVeto=20, 
     kfull5x5_sigmaIetaIeta=21, 
     kdEtaIn=22, 
     kdPhiIn=23, 
     khOverE=24, 
     krelIsoWithDBeta=25, 
     ...
     kisHeep51ElectronBoosted=44, 
     kisLooseElectronBoosted=45, 
     kpfRhoCorrRelIso03Boost=46, 
     kpfRhoCorrRelIso04Boost=47, 
     kpfDeltaCorrRelIsoBoost=48, 
     kpfRelIsoBoost=49, 
     kphotonIsoBoost=50, 
     kneutralHadIsoBoost=51, 
     kchargedHadIsoBoost=52, 
     kSemileptonicPFIso=53, 
     kSemileptonicCorrPFIso=54, 
     kisVetoElectron=4, 
     kisMediumElectron=5, 
     kisTightElectron=6, 
     kisHeepElectron=7, 
