...
def getXsec(sample):
  ...
  elif sample.find( "TTJets"                               ) !=-1 : return  831.76;
  ...
  elif sample.find( "WJetsToLNu_Tune"                      ) !=-1 : return 50380.0*1.22 ;
  elif sample.find( "W1JetsToLNu_Tune"                     ) !=-1 : return 9644.5*1.22 ;
  elif sample.find( "W2JetsToLNu_Tune"                     ) !=-1 : return 3144.5*1.22 ;
  elif sample.find( "W3JetsToLNu_Tune"                     ) !=-1 : return  954.8*1.22 ;
  elif sample.find( "W4JetsToLNu_Tune"                     ) !=-1 : return  485.6*1.22 ;
  elif sample.find("WW_Tune"                               ) !=-1 : return 118.7        ;
  elif sample.find("WZ_Tune"                               ) !=-1 : return 47.13        ;
  elif sample.find("ZZ_Tune"                               ) !=-1 : return 16.5         ;
  elif sample.find("ST_s-channel_4f_InclusiveDecays"       ) !=-1 : return 11.36        ;
  ...
  elif sample.find("W1JetsToLNu_LHEWpT_400-inf"            ) !=-1 : return 9644.5*1.22  ; #FIXME
  elif sample.find("W2JetsToLNu_LHEWpT_250-400"            ) !=-1 : return 3144.5*1.22  ; #FIXME
  elif sample.find("W2JetsToLNu_LHEWpT_400-inf"            ) !=-1 : return 3144.5*1.22  ; #FIXME
