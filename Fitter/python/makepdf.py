...
def MakeGeneralPdf(workspace,label,model,spectrum,wtagger_label, channel,constraint,peak="W",wsname = ""):
    ...
    if model == "ErfExp":
        ...
        rrv_width_ErfExp  = RooRealVar("rrv_width_ErfExp"+label+"_"+channel+spectrum,"rrv_width_ErfExp"+label+"_"+channel+spectrum,30.,1.,200.)
...
#             gaus3 = addConstraint(workspace,rrv_width_ErfExp,rrv_width_ErfExp.getVal(),rrv_width_ErfExp.getError(),constraint)
    ...
    if model.find("GausErfExp_ttbar")!=-1:
         ...
         if model.find("MC")!=-1:
             ...
             rrv_offset_ErfExp = RooRealVar("rrv_offset_ErfExp"+label+"_"+channel+spectrum ,"rrv_offset_ErfExp"+label+"_"+channel+spectrum ,offset_tmp,0,150)
             ...
             rrv_c_ErfExp      = RooRealVar("rrv_c_ErfExp"     +label+"_"+channel+spectrum ,"rrv_c_ErfExp"     +label+"_"+channel+spectrum ,c0_tmp,-1, +0 )
             rrv_frac = RooRealVar("rrv_frac"+label+"_"+channel+spectrum ,"rrv_frac"+label+"_"+channel+spectrum ,0.95,0.,1.)
#             if model.find("fail")!=-1: rrv_frac = RooRealVar("rrv_frac"+label+"_"+channel+spectrum ,"rrv_frac"+label+"_"+channel+spectrum ,0.67,0.6,1.)
    ...
    if model.find("DoubleCB")!=-1 and model.find("Gauss")==-1  :
        if model.find("fitMC")!=-1:
            ...
            rrv_sigma1_gaus  = RooRealVar("rrv_sigma1_gaus"+label+"_"+channel+spectrum,"rrv_sigma1_gaus"+label+"_"+channel+spectrum,6.8141e+00,gaussigmas*.75,gaussigmas*1.25)
            ...
            if wsname.find("ddt")!=-1:
                ...
                if label.find('fail')!=-1:
                    rrv_mean1_gaus   = RooRealVar("rrv_mean1_gaus"+label+"_"+channel+spectrum,"rrv_mean1_gaus"+label+"_"+channel+spectrum,81.,58,83)
        ...
        rrv_alpha1.setVal(2.)
        rrv_alpha1.setMin(1.0) # set it to 0.5 for tau21, 1.0 for tau21DDT
        if wsname.find("ddt")!=-1: rrv_alpha1.setMin(1.0)
        rrv_alpha2.setVal(2.)
        rrv_alpha2.setMin(0.5)
#        rrv_sign1.setVal(15)
#        rrv_sign1.setMin(0)
#        rrv_sign1.setMax(105)
#        rrv_sign2.setVal(15)
#        rrv_sign2.setMin(0)
#        rrv_sign2.setMax(105)
#        rrv_alpha1.setVal(-0.5)
#        rrv_alpha1.setMin(-5.)
#        rrv_alpha1.setMax(0.)
...
#        model_pdf       = ROOT.RooCBShape("model_pdf"+label+"_"+channel+spectrum,"model_pdf"+label+"_"+channel+spectrum, rrv_x, rrv_mean1_gaus, rrv_sigma1_gaus, rrv_alpha1, rrv_sign1)
#        model_pdf       = RooGaussian("model_pdf"+label+"_"+channel+spectrum,"model_pdf"+label+"_"+channel+spectrum, rrv_x, rrv_mean1_gaus, rrv_sigma1_gaus)
    ...
    if model.find("DoubleSidedCB")!=-1:
        rrv_mean1_gaus   = RooRealVar("rrv_mean1_gaus"+label+"_"+channel+spectrum,"rrv_mean1_gaus"+label+"_"+channel+spectrum, 82., 70., 110.)
        rrv_sigma1_gaus  = RooRealVar("rrv_sigma1_gaus"+label+"_"+channel+spectrum,"rrv_sigma1_gaus"+label+"_"+channel+spectrum, 8., 5., 12.)
        rrv_alpha1  = RooRealVar("rrv_alpha1"+label+"_"  +channel+spectrum, "rrv_alpha1"+label+"_"  +channel+spectrum, 2., 0.5, 10.) # setMin it to 0.5 for tau21, 1.0 for tau21DDT
        rrv_sign1   = RooRealVar("rrv_sign1" +label+"_"  +channel+spectrum, "rrv_sign1" +label+"_"  +channel+spectrum, 36, 0., 46.)
        rrv_alpha2  = RooRealVar("rrv_alpha2"+label+"_"  +channel+spectrum, "rrv_alpha2"+label+"_"  +channel+spectrum, 2., 0.5, 10.)
        rrv_sign2   = RooRealVar("rrv_sign2" +label+"_"  +channel+spectrum, "rrv_sign2" +label+"_"  +channel+spectrum, 15, 0., 46.)
        model_pdf   = RooGaussian("model_pdf"+label+"_"+channel+spectrum,"model_pdf"+label+"_"+channel+spectrum, rrv_x, rrv_mean1_gaus, rrv_sigma1_gaus)
#        model_pdf   = ROOT.RooDoubleCrystalBall("model_pdf"+label+"_"+channel+spectrum,"model_pdf"+label+"_"+channel+spectrum, rrv_x, rrv_mean1_gaus, rrv_sigma1_gaus, rrv_alpha1, rrv_sign1, rrv_alpha2, rrv_sign2)
