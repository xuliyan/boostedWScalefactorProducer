...
void fit_mj_single_MC(RooWorkspace*, const std::string & = "", const std::string & = "", const std::string & = "",const std::string & = "em", const std::string & = "HP", const int & = 0, const int & = 0);
...
void fit_mlvj_in_Mj_sideband(RooWorkspace*, std::map<std::string,int>, std::map<std::string,std::string>, const std::string & = "", const std::string & = "", const std::string & = "_sb_lo", const std::string & = "em", const std::string & = "HP", const std::string & = "", const int & = 0, const int & = 1, const int & = 0,const std::string & = "");
